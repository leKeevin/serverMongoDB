...
config() : void
{
    ...
    this.router.get('/holamundo/',(req,res) => res.send('Hola mundo esta es mi pagina web'));
    ...
    this.router.get('/chuy/',(req,res) => res.send("Wazaaaa"));
    this.router.get('/yack/',(req,res) => res.send("Wazaaaa"));
